...
**注意**: カテゴリはこの7つに固定。新カテゴリは追加しないこと。記事を書く際は必ずこの中から選ぶ。追加・変更はユーザーの明示的な指示があった場合のみ行う。
...
```
1. カテゴリ：以下の7つからどれにしますか？
   コーヒー / 焙煎 / グルテンフリー / 体験・イベント / ペット / 美容健康 / ダガヤサンドウ

2. 書きたいこと・伝えたいこと：メモ程度でOKです

3. まとめセクションをつけますか？（つける / つけない）

4. 記事末尾にQ&Aをつけますか？（つける / つけない）
